...
namespace SlimeGame 
{
    public abstract class PlaceBaseSubState : IState 
    {
        public PlaceBaseSubState(ControllerStateMachine context)
        {
            _ctx = context;
            _iconObject = _ctx.GetSubStateIconObject(ControllerStates.Place,PlaceStates);
        }
        ...
        public abstract PlaceStates PlaceStates { get; }
