...
namespace SlimeGame
{
    public interface ICellTypesCollection
    {
        ...
        public SylvesOrientedFace GetZeroOffsetOrientedFace(CellDir cellDirs,FaceDetails faceDetails)
        {
            return new(Vector3Int.zero,cellDirs,faceDetails);
        }
